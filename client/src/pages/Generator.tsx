  ...
  const handleGenerate = async(e: React.FormEvent<HTMLFormElement>) => {
    ...
    return (
      <div className="min-h-screen text-white p-6 md:p-12 mt-28">
        <form onSubmit={handleGenerate} className="max-w-4x1 mx-auto mb-40">
          ...
          <div className="flex gap-20 max-sm:flex-col items-start sm:px-20 justify-between">

            {/* left col */}
            <div className="flex flex-col w-full sm:max-w-60 gap-8 mt-8 mb-12">

              <UploadZone label="Model Image" file={productImage} onClear={() => {setProductImage(null)}} onChange={(e) => {handleFileChange(e,'product')}} />
